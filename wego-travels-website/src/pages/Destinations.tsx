          ...
          <div className="flex flex-wrap justify-center gap-3 mb-16">
            {categories.map((cat) => (
              <button
                ...
                className={`px-8 py-3 rounded-full text-sm font-bold uppercase tracking-wider transition-all duration-300 ${selectedCategory === cat
                  ...
                  <div className="bg-white rounded-[2.5rem] overflow-hidden shadow-sm hover:shadow-2xl transition-all duration-500 border border-gray-100 flex flex-col h-full transform hover:-translate-y-2">
                    <div className="relative h-72 overflow-hidden">
                      ...
                      <div className="absolute top-6 right-6">
                        <span className="px-4 py-2 bg-white/90 backdrop-blur-md text-blue-900 text-xs font-bold rounded-full shadow-lg">
                          {dest.price}
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="p-10 flex flex-col flex-grow">
                      <div className="flex items-center text-orange-500 text-sm font-bold uppercase tracking-widest mb-4">
                        <MapPin size={16} className="mr-2" />
                        {dest.country}
                      </div>

                      <h3 className="text-3xl font-bold text-blue-900 mb-6 group-hover:text-orange-500 transition-colors">
                        {dest.name}
                      </h3>

                      <div className="mt-auto pt-6 border-t border-gray-50 flex items-center text-[#0167B2] font-bold group-hover:translate-x-1 transition-transform">
          ...
          {visibleCount < filteredDestinations.length && (
            <div className="mt-20 text-center">
              <button
                ...
                className="inline-flex items-center gap-3 bg-white text-blue-900 border-2 border-blue-900 px-10 py-4 rounded-full font-bold text-lg hover:bg-blue-900 hover:text-white transition-all transform hover:scale-105 shadow-lg group"
              >
      ...
      >
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          <FadeInSection>
            ...
            <Link
              to="/contact"
              className="inline-flex items-center gap-3 bg-[#F48A34] text-white px-10 py-5 rounded-full font-bold text-lg hover:bg-orange-600 transition-all transform hover:scale-105 shadow-2xl group"
            >
