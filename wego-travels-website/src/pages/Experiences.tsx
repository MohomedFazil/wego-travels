        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {TESTIMONIALS.map((t, i) => (
              <FadeInSection key={i}>
                <div className="bg-white/70 backdrop-blur-xl border border-gray-100 p-10 rounded-[2.5rem] relative hover:shadow-2xl transition-all group shadow-xl">
                  <Quote className="absolute top-10 right-10 text-blue-900/5 w-20 h-20" />
                  <div className="flex items-center space-x-4 mb-8">
                    <img src={t.image} alt={t.name} className="w-14 h-14 rounded-full border-2 border-[#F48A34]" />
                    <div>
                      <h4 className="text-blue-900 font-bold">{t.name}</h4>
                    ...
                    <div className="p-8 md:p-16 bg-white">
                      <div className="flex flex-wrap items-center gap-8 mb-10 pb-8 border-b border-gray-100">
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <p className="text-[10px] text-gray-400 uppercase tracking-widest font-black">Rating</p>
                            <div className="flex">
