          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {services.map((service, idx) => (
              <FadeInSection key={idx}>
                <div className="h-full bg-white p-8 rounded-2xl border border-gray-100 hover:border-[#F48A34]/50 hover:shadow-2xl transition-all duration-500 group flex flex-col items-center text-center">
      ...
      <div className="bg-blue-900 py-32 relative overflow-hidden antialiased">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative">
            ...
            <div className="hidden lg:block absolute top-[44%] left-[15%] right-[15%] h-[1px] bg-white/20 -z-0" />
