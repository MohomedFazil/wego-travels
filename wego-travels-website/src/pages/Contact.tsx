          ...
          <FadeInSection>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-24">
              {[
                ...
                <div key={idx} className="p-8 md:p-6 lg:p-10 rounded-[2.5rem] border border-gray-100 hover:border-orange-200 hover:shadow-2xl transition-all duration-500 group bg-white shadow-sm flex flex-col h-full">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-start">
            ...
            <FadeInSection>
              <div className="bg-gray-50 p-10 md:p-16 rounded-[3rem] border border-gray-100 shadow-sm">
                <div className="mb-12">
                  <h2 className="text-3xl md:text-4xl font-bold text-blue-900 mb-4">Send a Message</h2>
                ...
                <form className="space-y-8">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        className="w-full px-8 py-4 bg-white border border-gray-100 rounded-2xl focus:ring-2 focus:ring-[#F48A34] focus:border-transparent outline-none transition-all shadow-sm"
                      />
                    </div>
                    <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <select className="w-full px-8 py-4 bg-white border border-gray-100 rounded-2xl focus:ring-2 focus:ring-[#F48A34] focus:border-transparent outline-none transition-all shadow-sm appearance-none cursor-pointer">
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea
                      ...
                      className="w-full px-8 py-6 bg-white border border-gray-100 rounded-3xl focus:ring-2 focus:ring-[#F48A34] focus:border-transparent outline-none transition-all shadow-sm resize-none"
                    ></textarea>
                  </div>

                  <button className="w-full bg-[#F48A34] text-white font-bold py-6 rounded-2xl hover:bg-orange-600 transition-all transform hover:scale-[1.02] shadow-xl flex items-center justify-center gap-3 text-lg group">
                    Send Message
