...
export function About() {
  return (
    <div className="bg-white overflow-x-hidden">
        ...
        <FadeInSection>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="order-1 lg:order-2 space-y-8">
              ...
              <div className="pt-4">
                <button className="text-blue-900 font-bold uppercase tracking-widest border-b-2 border-[#F48A34] pb-1 hover:text-orange-500 transition-colors">
                  Read Our Full Story
                </button>
              </div>
            </div>
      ...
      {/* Why Choose Us (Light Themed Redesign) */}
          ...
          <FadeInSection>
            <div className="relative mb-24 text-center">
              ...
              <div className="relative z-10 text-center">
                <div className="flex items-center justify-center space-x-3 mb-6">
                  <div className="h-[2px] w-12 bg-[#F48A34]"></div>
                  <span className="text-[#F48A34] font-bold tracking-widest uppercase text-sm">Key Benefits</span>
                  <div className="h-[2px] w-12 bg-[#F48A34]"></div>
                </div>
                <h2 className="text-3xl md:text-5xl font-bold text-blue-900 mb-6">Redefining the Way You See the World</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                <div key={idx} className="p-10 border border-gray-100 rounded-2xl bg-white hover:border-[#F48A34]/50 hover:shadow-lg transition-all duration-500 group">
                  <div className="mb-8 p-4 bg-blue-50 rounded-2xl w-16 h-16 flex items-center justify-center group-hover:bg-[#F48A34] transition-colors duration-500">
                    <item.icon className="w-8 h-8 text-[#0167B2] group-hover:text-white transition-colors duration-500" />
                  </div>
                  <h3 className="text-xl font-bold text-blue-900 mb-4 uppercase tracking-tight">{item.title}</h3>
